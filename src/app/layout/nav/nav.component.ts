...
export class NavComponent {
  ...
  onWindowScroll() {
    this.scrollPosition = window.scrollY * 0.9;
  }
  ...
  public onOverflow(state: boolean): void {
    this.isOverlay.set(state);
  }
